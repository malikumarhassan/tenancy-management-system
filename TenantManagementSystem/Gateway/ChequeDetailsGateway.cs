    ...
    public class ChequeDetailsGateway : Gateway
    {
        ...
        public int Delete(ChequeDetails aChequeDetails)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(aChequeDetails.ChequeNumber) && !string.IsNullOrEmpty(aChequeDetails.TenantAgreementNumber) && !string.IsNullOrEmpty(Convert.ToString(aChequeDetails.Amount)))
                {
                    Query = "DELETE FROM CHEQUEDETAILS WHERE TenantAgreementNumber = @tenantAgreementNumber AND ChequeNumber = @chequeNumber  AND Amount = @amount";
                ...
                {
                    Query = "DELETE FROM CHEQUEDETAILS WHERE Id = @id";
